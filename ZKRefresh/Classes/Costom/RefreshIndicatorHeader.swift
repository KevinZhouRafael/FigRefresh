...
public class RefreshIndicatorHeader:RefreshHeader{
    ...
    public override func refreshComponentDidMoveToSuperview() {
        ...
        activityIndicatorV.frame = CGRect(x: (frame.width - height/2)/2 - 45, y: height/4, width: height/2, height: height/2)
